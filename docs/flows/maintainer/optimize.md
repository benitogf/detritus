...
related: [list of other doc names, using full paths like flows/principles/truthseeker]
---
```
...
Check that:
- Every `related:` entry uses a full doc path (e.g. `flows/principles/truthseeker`, not just `truthseeker`)
